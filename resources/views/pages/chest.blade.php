...
@section('content')
    ...
    <section class="chest-exercise">
        <div class="container">
            <div class="exercise">
                <h1 class="arm-main-heading">
                    Easy Chest Exercises You Can Do At Home
                </h1>
                <div class="e1">
                    ...
                    <div class="e-img e1-img">
                        <img src="{{asset('images/c-pushups_400x300.jpg')}}" alt="arm-circles">
                    </div>
                </div>
                <div class="e-iframe">
                ...
                <div class="e2">
                    <div class="e-img e2-img">
                        <img src="{{asset('images/decline-push-ups.jpg')}}" alt="arm-circles">
                    </div>
                ...
                <div class="e3">
                    ...
                    <div class="e-img e3-img">
                        <img src="{{asset('images/diamond_push-ups.jpg')}}" alt="arm-circles">
                    </div>
                </div>
                <div class="e-iframe">
